...
export const CoinStorageContextProvider = props => {
    const [coinStorage, setCoinStorage] = useState(localStorage.getItem("coinStorage") ? localStorage.getItem("coinStorage").split(",")  : ['bitcoin', 'ethereum', 'ripple', 'litecoin', 'neo']);
